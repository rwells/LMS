                    ...
                    <table cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:Label ID="Label10" runat="server" Text="Category ID:"></asp:Label></td>
                            <td align="left" style="width: 192px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:DropDownList ID="lstid" runat="server" AutoPostBack="True" CausesValidation="True"
                                    OnSelectedIndexChanged="lstid_SelectedIndexChanged" Width="205px">
                                </asp:DropDownList></td>
                        ...
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:Label ID="UserNameLabel" runat="server">Category Name:</asp:Label></td>
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:TextBox ID="txtCName" runat="server" ValidationGroup="Login1" Width="200px" MaxLength="50" ReadOnly="True"></asp:TextBox></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="txtCName"
                                    ToolTip="Category Name is required." ValidationGroup="Login1">Category Name is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:Label ID="PasswordLabel" runat="server">Category Description:</asp:Label></td>
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:TextBox ID="txtcDesc" runat="server" TextMode="MultiLine" ValidationGroup="Login1"
                                    Width="200px" MaxLength="200"></asp:TextBox></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="txtcDesc"
                                    ToolTip="Category Description  is required." ValidationGroup="Login1">Category Description  is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                        ...
                        <tr>
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; height: 26px;
                                ...
                                <asp:Button ID="btnUpdate" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                    Font-Size="Small" ForeColor="Blue" Text="Update" OnClick="btnUpdate_Click" />
                                <asp:Button ID="btnDelete" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                    Font-Size="Small" ForeColor="Blue" Text="Delete" OnClick="btnDelete_Click" />
                               <asp:Button ID="btnClear" runat="server" OnClick="btnClear_Click" Text="Clear" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Small" ForeColor="Blue" /></td>
