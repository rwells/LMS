                    ...
                    <table cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 192px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:TextBox ID="txtCategory" runat="server" ReadOnly="True" Width="200px"></asp:TextBox></td>
                        ...
                        <tr>
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:TextBox ID="txtCName" runat="server" ValidationGroup="Login1" Width="200px" MaxLength="50"></asp:TextBox></td>
