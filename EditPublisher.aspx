<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EditPublisher.aspx.cs" Inherits="EditPublisher" %>
                ...
                <td align="center" colspan="2" style="height: 403px">
                    <table cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:Label ID="PasswordLabel" runat="server">Publisher Address:</asp:Label></td>
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ControlToValidate="txtPhone"
                                    ...
                                    ValidationGroup="Login1">Please enter valid Phone#.</asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                        ...
                        <tr>
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; height: 26px;
                                ...
                                <asp:Button ID="btnUpdate" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                    Font-Size="Small" ForeColor="Blue" OnClick="btnUpdate_Click" Text="Update" /><asp:Button
                                        ID="btnDelete" runat="server" Font-Bold="True" Font-Names="Times New Roman" Font-Size="Small"
                                        ForeColor="Blue" OnClick="btnDelete_Click" Text="Delete" />&nbsp;<asp:Button ID="btnClear"
