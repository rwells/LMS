                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="txtBTitle"
                                    ToolTip="Book title is required." ValidationGroup="Login1">Book title is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td align="left" style="width: 192px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:DropDownList ID="LstAuthor" runat="server" ValidationGroup="Login1" Width="205px">
                                </asp:DropDownList>
                            </td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="LstAuthor"
                                    ToolTip="Author is required." ValidationGroup="Login1">Author is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:DropDownList ID="LstPublisher" runat="server" ValidationGroup="Login1" Width="205px">
                                </asp:DropDownList></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="LstPublisher"
                                    ToolTip="Publisher is required." ValidationGroup="Login1">Publisher is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:DropDownList ID="LstCategory" runat="server" ValidationGroup="Login1" Width="205px">
                                </asp:DropDownList></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="LstCategory"
                                    ToolTip="Category is required." ValidationGroup="Login1">Category is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:DropDownList ID="LstSupplier" runat="server" ValidationGroup="Login1" Width="205px">
                                </asp:DropDownList></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RequiredFieldValidator ID="PasswordRequired" runat="server" ControlToValidate="LstSupplier"
                                    ToolTip="Supplier is required." ValidationGroup="Login1">Supplier is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                        ...
                        <tr>
                            ...
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtIsbn"
                                    ToolTip="ISBN is required." ValidationGroup="Login1">ISBN is required.</asp:RequiredFieldValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtQuantity"
                                    ErrorMessage="RegularExpressionValidator" ValidationExpression="\d[0-9]*" ValidationGroup="Login1">Please enter valid Quantity.</asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                            ...
                            <td align="left" style="width: 192px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:TextBox ID="txtPrice" runat="server" MaxLength="5" ValidationGroup="Login1"
                                    Width="200px"></asp:TextBox></td>
                            <td align="left" style="width: 207px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator3" runat="server" ControlToValidate="txtPrice"
                                    ErrorMessage="RegularExpressionValidator" ValidationExpression="\d[0-9]*" ValidationGroup="Login1">Please enter valid Price.</asp:RegularExpressionValidator></td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                        ...
                        <tr>
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; height: 26px;
                                ...
                                <asp:Button ID="btnUpdate" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                    Font-Size="Small" ForeColor="Blue" OnClick="btnUpdate_Click" Text="Update" ValidationGroup="Login1" />
                                <asp:Button ID="btnDelete" runat="server" Font-Bold="True" Font-Names="Times New Roman"
                                    Font-Size="Small" ForeColor="Blue" OnClick="btnDelete_Click" Text="Delete" ValidationGroup="Login1" />
