                    ...
                    <table cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc; height: 26px;">
                            ...
                            <td align="left" style="width: 192px; color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc; height: 26px;">
                                <asp:TextBox ID="txtSupplier" runat="server" ReadOnly="True" Width="200px"></asp:TextBox></td>
                            <td style="width: 207px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc; height: 26px;">
                            </td>
                        </tr>
                        <tr>
                            <td align="right" style="width: 153px; color: #0000cc; font-family: 'Times New Roman';
                            ...
                            <td style="width: 192px; color: #0000cc; font-family: 'Times New Roman'; background-color: #ffffcc">
                                <asp:TextBox ID="txtSName" runat="server" ValidationGroup="Login1" Width="200px" MaxLength="50"></asp:TextBox></td>
