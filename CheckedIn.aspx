<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CheckedIn.aspx.cs" Inherits="CheckedIn" %>
                    ...
                    <table cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            <td align="center" colspan="3" style="color: #0000cc; font-family: 'Times New Roman';
                                background-color: #ffffcc">
                                &nbsp;<asp:GridView ID="gvBook" runat="server" BackColor="LemonChiffon" BorderStyle="Groove" CaptionAlign="Bottom" CellPadding="1" Font-Names="Times New Roman" Font-Size="Small" ForeColor="Teal" HorizontalAlign="Center">
